...
import { UserAdministrationSettingsComponent } from './component/user-administration-settings/user-administration-settings.component';
...
@NgModule({
  declarations: [
    ...
    SettingsComponent,
    UserAdministrationSettingsComponent,
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
